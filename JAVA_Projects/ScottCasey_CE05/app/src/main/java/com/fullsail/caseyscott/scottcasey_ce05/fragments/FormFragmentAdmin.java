...
public class FormFragmentAdmin extends Fragment {


    private SubmitInformationListener mListener;

    public static FormFragmentAdmin newInstance() {

        Bundle args = new Bundle();

        FormFragmentAdmin fragment = new FormFragmentAdmin();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.form_fragment_admin, container, false);
    }
            ...
            addButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Objects.equals(firstName.trim(), getString(R.string.blank)) && Objects.equals(lastName.trim(), getString(R.string.blank)) && Objects.equals(opt.trim(), getString(R.string.blank))){
                        ...
                        Administrator a = new Administrator(firstName, lastName, opt);
                        mListener.submitInformation(a);
