...
public class FormFragmentInstructor extends Fragment {
    private SubmitInformationListener mListener;


    public static FormFragmentInstructor newInstance() {

        Bundle args = new Bundle();

        FormFragmentInstructor fragment = new FormFragmentInstructor();
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.form_fragment_instructor, container, false);
    }
            ...
            addButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Objects.equals(firstName.trim(), getString(R.string.blank)) && Objects.equals(lastName.trim(), getString(R.string.blank)) && Objects.equals(opt.trim(), getString(R.string.blank))){
                        ...
                        Teacher t = new Teacher(firstName, lastName, opt);
                        mListener.submitInformation(t);
