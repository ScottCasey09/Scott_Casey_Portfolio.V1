// Casey Scott
// FINAL PROJECT - 1712
// AccountSettingsActivityTablet.java
...
public class AccountSettingsActivityTablet extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        utils = new NetworkUtils(AccountSettingsActivityTablet.this);
    }
    ...
    private void askUserIfTheyReallyWantToChange(){
        ...
        (dialog.findViewById(R.id.commit)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                ProgressDialog progressDialog = new ProgressDialog(AccountSettingsActivityTablet.this);
                ...
                if(utils.checkInternetConnection()){
                                ...
                                mAuth.getCurrentUser().updateEmail(emailStr).addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if (task.isSuccessful()) {
                                                ...
                                                mAuth.getCurrentUser().updateEmail(emailStr).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                    ...
                                                    public void onComplete(@NonNull Task<Void> task) {
                                                        if (task.isSuccessful()) {
                                                            ...
                                                            Toast.makeText(AccountSettingsActivityTablet.this, R.string.password_not_updated, Toast.LENGTH_SHORT).show();
                                                            dialog.dismiss();
                                                        }
                                                    }
                                                });
                                            ...
                                            Toast.makeText(AccountSettingsActivityTablet.this, R.string.email_not_updated, Toast.LENGTH_SHORT).show();
                                            dialog.dismiss();
                                        }
                                    }
                                });
                    ...
                    Toast.makeText(AccountSettingsActivityTablet.this, getString(R.string.no_internet), Toast.LENGTH_SHORT).show();
                    dialog.dismiss();
                }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case android.R.id.home:
                Intent intent = new Intent(LandingActivity.ACTION_FORECAST);
                intent.putExtra("user", employee);
                startActivity(intent);
                return true;
        }
