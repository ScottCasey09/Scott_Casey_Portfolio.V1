...
public class HoursTotalActivityTablet extends AppCompatActivity {
                        ...
                        for (int i = 0; i < 7; i++) {
                            ...
                            if (dateKey.contains(ranges.get(i))) {
                                ...
                                //set the default hours totals if the employee did not clock out that day
                                    ...
                                    hoursTotal += employee.getDefaultHour();
                                    employee.getEmployees().get(s).getDays().get(str).setClockOutTime(employee.getEmployees().get(s).getDays().get(str).getClockInTime()+(employee.getDefaultHour()*3600000));
    ...
    private Pair<String, String> getWeekRange(int year, int week_no) {
        ...
        //Set the calendar to the last day of the qweek
